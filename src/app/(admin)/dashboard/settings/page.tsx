...
export default function SettingsModuleHome() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
            <div className="dark:bg-[#1a2d3b] rounded-sm shadow-xl px-8 py-6 max-w-lg text-center">
                <h1 className="text-2xl font-bold text-[#205D80] dark:text-white mb-2">
                    Welcome to the Settings Module
                </h1>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Use the sidebar to register new users, manage existing users, or configure system settings like roles and permissions.
                </p>
